...
export const sequelize = new Sequelize({
  ...
  storage: (dbConfig as any).storage || undefined,
  database: (dbConfig as any).database || undefined,
  username: (dbConfig as any).username || undefined,
  password: (dbConfig as any).password || undefined,
  host: (dbConfig as any).host || undefined,
  port: (dbConfig as any).port || undefined,
  logging: dbConfig.logging,
  timezone: (dbConfig as any).timezone || undefined,
